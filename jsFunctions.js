...
The function should print all the numbers from the array that are smaller than the number that was passed in.
*/
var array = [1, 2, 5, 8, 10, 14, 21, 29, 37, 42, 59, 64, 70];
var number = 13;
var numArr = allNumSmaller(array, number);

function allNumSmaller (arr, num) {
    var numArr = [];
